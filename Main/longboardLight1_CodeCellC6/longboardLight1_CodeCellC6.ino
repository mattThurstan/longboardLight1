/*
    'longboardLight1_CodeCellC6' by Thurstan. LED longboard lights with motion tracking.
...
float accelX = 0.0;  // X-axis acceleration
float accelY = 0.0;  // Y-axis acceleration
float accelZ = 0.0;  // Z-axis acceleration
...
void setup() {
  ...
  myCodeCell.Init(LIGHT + MOTION_ACCELEROMETER + MOTION_ROTATION + MOTION_STATE);
